    ...
    return (
        <>
            ...
            <main>
                ...
                <div className="flex flex-col w-full px-6 py-6 md:py-12 bg-primary mt-[-130px] md:mt-[-200px]">
                    <div className="md:max-w-[1400px] md:w-full mx-auto">
                        <div className="flex flex-col md:flex-row">
                            <div className='md:w-1/2'>
                                ...
                                <ul className="mb-6">
                                    <li className="flex text-[12px] md:text-xl leading-6">
                                        <img
                                            src="/checkmark.svg"
                ...
                <div className="flex flex-col w-full px-6 py-6 md:py-12">
                    <div className="md:max-w-[1400px] mx-auto">
                        ...
                        <div>
                            <p className="flex text-[12px] md:text-xl">
                                <span className="w-1/2 mr-4 md:w-[350px]">Entreegeld</span>
                                <span> €10.000 (eenmalig)</span>
                            </p>
                            <p className="flex text-[12px] md:text-xl">
                                <span className="w-1/2 mr-4 md:w-[350px]">
                                    {' '}
                                    Formulebeheer
                                </span>
                            ...
                            <p className="flex text-[12px] md:text-xl">
                                <span className="w-1/2 mr-4 md:w-[350px]">Marketingfee</span>
                        ...
                        <p className="mb-6 mt-6 text-[12px] md:text-xl">
                ...
                <div className="flex flex-col w-full px-6 py-6 md:py-12 bg-secondary md:z-10 md:relative md:mb-[-150px] md:mx-auto md:w-[1400px]">
                    <div className="flex flex-col md:max-w-[1400px]">
                        ...
                        <button
                            ...
                            className="w-3/4 md:w-auto px-8 py-2 md:py-6 mt-4 text-xs md:text-2xl font-bold text-primary rounded bg-[#FFF] ml-auto mr-auto md:text-[#fff] md:bg-primary md:rounded-full"
                        >
                            Contactforumlier
                        </button>
                    </div>
